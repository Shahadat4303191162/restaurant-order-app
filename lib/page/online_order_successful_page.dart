...
class OnlineOrderSuccessfulPage extends StatefulWidget {
  static const String routeName = '/successful';
  const OnlineOrderSuccessfulPage({Key? key}) : super(key: key);

  @override
  State<OnlineOrderSuccessfulPage> createState() => _OnlineOrderSuccessfulPageState();
}

class _OnlineOrderSuccessfulPageState extends State<OnlineOrderSuccessfulPage> {
  ...
  Widget build(BuildContext context) {
    final bil = ModalRoute.of(context)!.settings.arguments as num;
    return Scaffold(
      appBar: AppBar(
